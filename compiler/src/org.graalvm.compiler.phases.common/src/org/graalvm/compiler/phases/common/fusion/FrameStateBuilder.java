...
public final class FrameStateBuilder implements SideEffectsState {
     ...
     */
    public FrameStateBuilder(ResolvedJavaMethod method, StructuredGraph graph) {
        this(new ResolvedJavaMethodBytecode(method), graph);
    }
     ...
     * @param graph the target graph of Graal nodes created by the builder
     */
    public FrameStateBuilder(Bytecode code, StructuredGraph graph) {
        this.code = code;
    ...
    public FrameState create(int bci, StateSplit forStateSplit) {
        ...
        return create(bci, false, null, null);
    }
     ...
     */
    public FrameState create(int bci, boolean duringCall, JavaKind[] pushedSlotKinds, ValueNode[] pushedValues) {
